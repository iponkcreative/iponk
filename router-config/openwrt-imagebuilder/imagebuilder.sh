...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        kmod-usb-net-rndis kmod-usb-net-cdc-ncm kmod-usb-serial-wwan \
        kmod-nls-base kmod-usb-core kmod-usb-net kmod-usb2 kmod-usb-net-cdc-ether usb-modeswitch \
        kmod-usb-net-asix kmod-usb-net-asix-ax88179 kmod-usb-net-dm9601-ether \
        kmod-usb-net-hso kmod-usb-net-kalmia kmod-usb-net-kaweth \
